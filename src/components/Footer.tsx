      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <p className="text-sm text-secondary-foreground/80 leading-relaxed">Professionele logopedische behandeling voor kinderen en volwassenen in 
's-Hertogenbosch. Geregistreerd bij het Kwaliteitsregister Paramedici.</p>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {quickLinks.map(link => <li key={link.name}>
                  <Link to={link.path} className="text-sm text-secondary-foreground/80 hover:text-primary transition-colors inline-flex items-center gap-2 group">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="grid grid-cols-1 gap-6">
              {locations.map((location, index) => <div key={index} className="space-y-2 p-4 rounded-lg bg-secondary-foreground/5 hover:bg-secondary-foreground/10 transition-colors">
                  ...
                  <div className="space-y-1.5 text-xs text-secondary-foreground/70">
                    ...
                    <a href={`tel:${location.phone.replace(/[\s-]/g, '')}`} className="flex items-center gap-2 hover:text-primary transition-colors">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3">
              <a href="mailto:info@logopediedenbosch.nl" className="flex items-center gap-3 text-sm text-secondary-foreground/90 hover:text-primary transition-colors group">
                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                  <Mail className="h-4 w-4 text-primary" />
                </div>
                <span>info@logopediedenbosch.nl</span>
              </a>
              <a href="tel:073-6433400" className="flex items-center gap-3 text-sm text-secondary-foreground/90 hover:text-primary transition-colors group">
                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
