      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          <div className="relative animate-fade-in-left">
            ...
            {/* Floating Stats */}
            <div className="absolute -bottom-6 -right-2 mr-8 md:mr-0 sm:-bottom-8 sm:-right-8 bg-card p-4 sm:p-6 rounded-xl shadow-xl border border-primary/20 animate-float">
